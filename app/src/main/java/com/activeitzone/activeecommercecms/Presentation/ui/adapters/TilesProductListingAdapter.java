...
public class TilesProductListingAdapter extends RecyclerView.Adapter<TilesProductListingAdapter.ViewHolder> {
    ...
    public TilesProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
