...
public class FloorTilesProductListingAdapter extends RecyclerView.Adapter<FloorTilesProductListingAdapter.ViewHolder> {
    ...
    public FloorTilesProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
