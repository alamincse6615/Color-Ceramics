...
public class BricksProductListingAdapter extends RecyclerView.Adapter<BricksProductListingAdapter.ViewHolder> {
    ...
    public BricksProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
