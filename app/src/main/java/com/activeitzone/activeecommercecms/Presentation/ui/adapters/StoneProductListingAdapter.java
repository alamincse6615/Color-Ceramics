...
public class StoneProductListingAdapter extends RecyclerView.Adapter<StoneProductListingAdapter.ViewHolder> {
    ...
    public StoneProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
