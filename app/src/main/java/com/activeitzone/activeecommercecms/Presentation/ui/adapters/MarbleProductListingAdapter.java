...
public class MarbleProductListingAdapter extends RecyclerView.Adapter<MarbleProductListingAdapter.ViewHolder> {
    ...
    public MarbleProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
