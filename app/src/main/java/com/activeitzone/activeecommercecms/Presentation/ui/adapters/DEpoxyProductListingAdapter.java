...
public class DEpoxyProductListingAdapter extends RecyclerView.Adapter<DEpoxyProductListingAdapter.ViewHolder> {
    ...
    public DEpoxyProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
