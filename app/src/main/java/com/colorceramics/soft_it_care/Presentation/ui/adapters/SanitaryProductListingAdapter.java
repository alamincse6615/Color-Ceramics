...
public class SanitaryProductListingAdapter extends RecyclerView.Adapter<SanitaryProductListingAdapter.ViewHolder> {
    ...
    public SanitaryProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
