...
public class GraniteProductListingAdapter extends RecyclerView.Adapter<GraniteProductListingAdapter.ViewHolder> {
    ...
    public GraniteProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
