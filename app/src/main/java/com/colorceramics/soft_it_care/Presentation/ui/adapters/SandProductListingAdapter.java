...
public class SandProductListingAdapter extends RecyclerView.Adapter<SandProductListingAdapter.ViewHolder> {
    ...
    public SandProductListingAdapter(Context context, List<Product> mProducts, ProductClickListener productClickListener) {
